...
echo "stderr_logfile=/var/log/kudos/workserver.err.log" >> scripts/workserver.conf
echo "stdout_logfile=/var/log/kudos/workserver.out.log" >> scripts/workserver.conf
